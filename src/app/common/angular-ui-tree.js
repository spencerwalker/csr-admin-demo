 ...
 * (c) 2010-2015. https://github.com/angular-ui-tree/angular-ui-tree test
 * License: MIT
 */
(function () {
    'use strict';
        ...
        .controller('TreeNodeController', ['$scope', '$element',
            function ($scope, $element) {
                ...
                $scope.index = function () {
                    return $scope.$modelValue ? $scope.$parentNodesScope.$modelValue.indexOf($scope.$modelValue) : $scope.$parent.$index;
                };
        ...
        .controller('TreeNodesController', ['$scope', '$element',
            function ($scope, $element) {
                ...
                $scope.removeNode = function (node) {
                    if (!node.$modelValue) return null;
                ...
                $scope.insertNode = function (index, nodeData) {
                    if (!$scope.$modelValue.splice) return;
                    $scope.safeApply(function () {
